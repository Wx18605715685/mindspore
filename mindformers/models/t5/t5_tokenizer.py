    ...
    """
        ...
        refer to this superclass for more information regarding those methods.
            ...
            eos_token (`str`, *optional*, defaults to `"</s>"`):
                ...
                of sequence. The token used is the `sep_token`.

                </Tip>

            unk_token (`str`, *optional*, defaults to `"<unk>"`):
                The unknown token. A token that is not in the vocabulary cannot be converted to an ID and is set to
                be this token instead.
            ...
            legacy (`bool`, *optional*):
                Whether or not the `legacy` behaviour of the tokenizer should be used. Legacy is before the merge
    ...
    def __init__(
        ...
        if legacy is None:
            logger.warning(
                ...
                f"means that the `legacy` (previous) behavior will be used so nothing changes for you. If you want to "
                f"use the new behaviour, set `legacy=False`. This should only be set if you understand what it means, "
                f"and thoroughly read the reason why this was added as explained in "
                f"https://github.com/huggingface/transformers/pull/24565"
            )
            legacy = True
