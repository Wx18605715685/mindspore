...
def get_checkpoint_shard_files(
    ...
    for shard_filename in tqdm(shard_filenames, desc="Downloading shards", disable=not show_progress_bar):
        ...
        # TODO 替换此ERROR为hub_utils中对应的ERROR
...
def has_file(
    ...
    try:
        # TODO replace function with corresponding one in hub_utils after code merged
        hf_raise_for_status(r)
        return True
    # TODO replace exception with corresponding one in hub_utils after code merged
    except GatedRepoError as e:
        logger.error(e)
        raise EnvironmentError(
            # TODO add community url to replace xxx, add cli login command for generating token to replace {xxx}
...
class PushToHubMixin:
    ...
    def _create_repo(
        ...
        the token.
        """
        # TODO replace this function with corresponding one in hub_utils after code merged
        ...
        for file in modified_files:
            if os.path.isdir(os.path.join(working_dir, file)):
                ...
                for f in os.listdir(os.path.join(working_dir, file)):
                    operations.append(
                        # TODO replace this object with corresponding one in hub_utils after code merged
                        CommitOperationAdd(
